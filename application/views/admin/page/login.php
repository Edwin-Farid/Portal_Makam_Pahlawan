...
<head>
  ...
  <title>Admin | Makam Pahlawan</title>
  <link rel="icon" href="<?= base_url() ?>assets/dashboard/assets/img/Logo_NW.png">
  <meta name="description" content="Mts Nwdi Pancor Lombok Timur">
  <meta content="" name="description">
  <meta content="" name="keywords">

  <link href="<?= base_url() ?>assets/dashboard/assets/img/Logo_NW.png" rel="icon">
  <link href="<?= base_url() ?>assets/dashboard/assets/img/Logo_NW.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Admin | Makam Pahlawan</span>
                </a>
              </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukan nama pengguna & kata sandi untuk masuk !</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="POST" action="<?php echo base_url('Admin/aksi_login'); ?>">
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Nama Pengguna</label>
                      <div class="input-group has-validation">
                        <input type="text" name="username" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Mohon untuk memasukan nama pengguna!</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Mohon untuk memasukan kata sandi!</div>
                    </div>
